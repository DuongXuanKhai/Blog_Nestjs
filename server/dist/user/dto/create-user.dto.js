...
__decorate([
    ...
    (0, class_validator_1.MinLength)(5, { message: 'Password minimum length is 5' }),
    __metadata("design:type", String)
], CreateUserDto.prototype, "password", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Avatar can not be empty' }),
    (0, class_validator_1.IsString)({ message: 'Avatar should be string' }),
    __metadata("design:type", String)
